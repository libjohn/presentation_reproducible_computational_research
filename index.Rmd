...
```{r echo=FALSE}
fontawesome::fa(name = "tasks", fill = "#ffd960", fill_opacity = .6, height = "12em", width = "12em")
...
.center[
```{r echo=FALSE}
fontawesome::fa(name = "database", fill = "#a1b83a", fill_opacity = .6, height = "6em", width = "6em")
# fontawesome::fa_png(name = "tasks", file = "images/tasks.png", fill = "goldenrod", fill_opacity = .4, height = "5in")
```
]  
...
.center[
```{r echo=FALSE}
fontawesome::fa(name = "server", fill = "#a1b83a", fill_opacity = .6, height = "6em", width = "6em")
# fontawesome::fa_png(name = "tasks", file = "images/tasks.png", fill = "goldenrod", fill_opacity = .4, height = "5in")
```
]
...
```{r echo=FALSE}
fontawesome::fa(name = "gitlab")  
```

```{r echo=FALSE}
fontawesome::fa(name = "bitbucket")  
```
...
.f4[ProjectName/
  ...
  - Dataset/
    ...
    - Processed Data/
      - YYYY-MM-DDVersion(s)
      - Better than YYYY-mm-DD:  use version control
    - Analysis (or Code)/
      - Data cleaning/
      - Data preprocessing/
      - Output/
        ...
        - Tables
    - Publications/
      - Data Products (R Markdown reports, slides, dashboards, MS Word, PDF, LaTex)
      - .bib file]


.f4[https://guides.lib.berkeley.edu/c.php?g=652220&p=4575532]
