...
Use source code as the _workflow orchestrator_ to manage project elements
...
.absolute.w-80pct.pa-3.l-1-12th.t-40pct.ba.bw-4.br-4[
```{r echo=FALSE}
...
fontawesome::fa(name = "plus", fill = "silver", height = "2em", width = "2em", fill_opacity = .6) 
