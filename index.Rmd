...
.bg-washed-red[↑ Example jupyter notebook ↑]  
...
Leverage your literate coding analysis and report writing

- _Reports are derived and rendered_ from literate code documents
...
-  _Version Control_ = (Git) + Social Coding 
  - Social Coding Hubs = collaboration + self-documenting your project's story within a .bg-gold[code repository] .gray.f3[GitHub ● GitLab ● BitBucket]
-  .bg-gold[Archival repositories]  
...
-  _Containers_: computational and archival representations of your project at various publishable milestones
  - does not require a _reader_ to set up a replica compute environment
  
---
# DOIs and Containers Example
