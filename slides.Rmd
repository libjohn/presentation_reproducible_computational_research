...
.absolute.w-2-12th.l-2-12th.t-30pct.pa2.br-4[
```{r echo=FALSE}
fontawesome::fa(name = "route", fill = "#ef9921", height = "6em", width = "6em", fill_opacity = .8) 
```
]

.absolute.w-4-12th.l-6-12th.t-30pct.pa2.br-4[1. Data wrangling 
2. Analysis 
3. Visualization
4. Reporting 
5. Archiving]
...
.absolute.w-5-12th.pa-3.l-6-12th.t-30pct[
```{r echo=FALSE}
